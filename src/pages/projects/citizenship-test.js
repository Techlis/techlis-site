      ...
      <div className="inner">
        <section id="canadian-citizenship-test">
          ...
          <span className="image right">
            <StaticImage
              src={'../../assets/images/icons/canada_citizen_icon.png'}
              alt=""
            />
          </span>
          <p>
            Failure rates for immigrants writing citizenship tests have soared
            when tougher questions and revamped rules made it harder for
            newcomers to become Canadian. This application is used to study and
            prepare you for the Canadian Citizenship Test. Intended to be plain
            simple and easy to learn; By using the app, you not only study fast,
            but also finish the real test as quick as possible. Records show
            that most people using the app only need 5 minutes to complete the
            real test.
          </p>
          <p>
            The practice test questions derived from the book Discover Canada,
            on which the test is based. All questions and answers have been
            selected carefully and verified as close as the real test. The
            actual Citizenship Exam consists of twenty multiple choice
            questions. You can use this application to practice answering the
            same multiple choice questions that may appear on the real
            citizenship test, or simply understand more about Canada. Keep
          ...
          <p>
            * Please note: The app doesn't mean to be a study guide for your
            ...
            you have any concern about the app, please do not hesitate to email
            us directly. We always listen.
          </p>
          <p>Highlight keys of features:</p>
          <ul>
            <li>
              All questions and answers have been selected carefully and
              verified as close as the 'real' test as well as updated frequently
            </li>
            <li>
        ...
        <section id="australian-citizenship-test">
          ...
          <span className="image right">
            <StaticImage
              src={'../../assets/images/icons/australia_citizen_icon.png'}
              alt=""
            />
          </span>
          <p>
            This application is used to study and prepare you for the
            "Australian Citizenship Test". The citizenship test is designed to
            assess whether you have an adequate knowledge of Australia and the
            responsibilities and privileges of Australian citizenship. English
            is our national language. Communicating in English helps you to play
            a more active role in Australian society. It helps you to take full
            advantage of education, employment and the other opportunities
            Australia has to offer. The actual Test consists of twenty multiple
            choice questions. You can use this application to practice answering
            the same multiple choice questions that may appear on the real
            citizenship test, or simply understand more about Australian. Keep
            practice makes perfect!
          </p>
          <p>
            * Please note: The app doesn't mean to be a study guide for your
        ...
        <section id="life-in-uk-test">
          ...
          <span className="image right">
            <StaticImage
              src={'../../assets/images/icons/uk_citizen_icon.png'}
              alt=""
            />
          </span>
          <p>
            This application is used to study and prepare you for the UK
            Citizenship or settlement, known as Life in the UK Test. The
            practice test consists of nearly thousand multiple choice questions
            derived from the book 'Life in the United Kindom: A Journey to
            Citizenship', on which the test is based. The actual Citizenship
            Exam consists of twenty four multiple choice questions. You can use
            this application to practice answering the same multiple choice
            questions that may appear on the real citizenship test, or simply
            understand more about UK. Keep practice makes perfect!
          </p>
          <p>
            * Please note: The app doesn't mean to be a study guide for your
            citizenship test. We encourage users to review the book as well. If
        ...
        <section id="us-citizenship-test">
          ...
          <span className="image right">
            <StaticImage
              src={'../../assets/images/icons/us_citizen_icon.png'}
              alt=""
            />
          </span>
          <p>
          ...
          <ul>
            ...
            <li>Keep track of the subjects that you need to improve</li>
            <li>
              "Online Materials" section will provide helpful information and
              more resource to prepare for the test.
            </li>
          </ul>
          <p>
