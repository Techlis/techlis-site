    ...
    <div>
        ...
        <div className="alt inner">
            <section id="canadian-citizenship-test">
                ...
                <ul>
                    <li>All questions and answers have been selected carefully and verified as close as the 'real' test as well as updated frequently</li>
                    <li>Randomly generate test questions for every test. Never do the same test again</li>
                    <li>Determine whether you passed or failed the test and able to review wrong or all tested questions</li>
                    <li>"Study Questions" Section helps you to learn all questions and answers easily and categorized base on test subjects.</li>
                    <li>Keep track of the subjects that you need to improve</li>
                    <li>Read online book 'Discover Canada' right in the app</li>
                </ul>
                <p>Canadian Citizenship Test
                <AppStoreLink 
            ...
            <section id="australian-citizenship-test">
                ...
                <ul>
                    ...
                    <li>Get more understand about the test/app and help from "Extras" Section</li>
                </ul>
                <p>Australian Citizenship Test
                <AppStoreLink 
            ...
            <section id="us-citizenship-test">
                ...
                <ul>
                    ...
                    <li>"Study Questions" Section helps you to learn all questions and answers easily and categorized base on test subjects.</li>
                    <li>Keep track of the subjects that you need to improve</li>
                    <li>"Online Materials" section will provide helpful information and more resource to prepare for the test.</li>
                </ul>
                <p>US Citizenship Naturalization Test
                <AppStoreLink 
