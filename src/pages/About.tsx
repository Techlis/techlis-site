        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
              ...
              AI innovation, helping businesses harness the power of artificial
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
              ...
              practical business solutions. We believe that every organization,
              regardless of size, should have access to the transformative power
              of AI.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="pt-8">
              <p className="text-lg text-gray-600 mb-6">
                ...
                {COMPANY_DATA.locations.join(", ")}, we combine local expertise
                with global reach.
              </p>
            </div>
          </motion.div>
