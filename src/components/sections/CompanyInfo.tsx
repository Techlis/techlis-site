    ...
    <div className="grid gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-3">
      ...
      <Card className="group hover:shadow-xl transition-all duration-300">
        <CardHeader className="p-4 sm:p-6">
          <CardTitle className="text-lg sm:text-xl font-semibold text-blue-600 flex items-center gap-2">
      ...
      <Card className="group hover:shadow-xl transition-all duration-300">
        <CardHeader className="p-4 sm:p-6">
          <CardTitle className="text-lg sm:text-xl font-semibold text-purple-600 flex items-center gap-2">
      ...
      <Card className="group hover:shadow-xl transition-all duration-300 md:col-span-2 lg:col-span-1">
        <CardHeader className="p-4 sm:p-6">
          <CardTitle className="text-lg sm:text-xl font-semibold text-yellow-600 flex items-center gap-2">
            <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-yellow-100 flex items-center justify-center">
          ...
          <ul className="space-y-2 sm:space-y-3">
            {values.map((value, index) => (
              <li key={index} className="flex items-start gap-2">
                <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 mt-1.5 sm:mt-2 flex-shrink-0" />
