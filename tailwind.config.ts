  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'luxury-gradient': 'linear-gradient(135deg, #fbbf24 0%, #f59e0b 25%, #8b5cf6 50%, #7c3aed 75%, #10b981 100%)',
        'shimmer-gradient': 'linear-gradient(110deg, transparent 25%, rgba(255,255,255,0.1) 50%, transparent 75%)',
      },
      backdropBlur: {
        xs: '2px',
      },
